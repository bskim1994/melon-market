function Dashboard() {
    return (
        <div class="mb-6 ">
            <div class="z-10 top-0 h-16 border-b bg-white py-3">
                <div class="px-6 items-center flex justify-between space-x-4">
                    <h5 class="text-2xl text-gray-600 font-medium">Dashboard</h5>
                    <div class="flex space-x-4">
                        <div hidden class="flex md:block">
                        ...
                        <button aria-label="chat" class="ml-4 w-10 h-10 rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200">
